         ...
         <div id="banner" role="banner">
            <div class="container-fluid">
               <div class="row">
                  ...
                  <div class="col-xs-5"><a href="#" id="herErDu">Solsiden</a></div>
              </div>
            </div>
</header>
...
<div class="container" id="sanntidBox">
   <div class="row" id="bussrad">
                ...
                <div class="col-xs-1 col-md-1"><h3 href="#" class="lineRef" data-content="lineRef"></h3>
                  </div>
                <div class="col-xs-3 col-md-3"><p href="#" id="buss" class="busName" data-content="busName"></p>
                  </div>
                <div class="col-xs-1 col-md-3"><p href="#"></p>
                  </div>
...
<footer id="main-footer">
         <p>
            Author's name. All rights reserved. Copyright &copy; 2012 - forever.
         </p>
      </footer> 
   </body>
